...
<body data-spy="scroll" data-target=".navbar" data-offset="51">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" onclick="playAudio()">
    ...
    <!-- <div id="welcomeModal" class="modal">
        <div class="modal-content">
            ...
            <p>This is a blocking modal with a big button to close it. Click the button below to start playing audio.</p>
            <button onclick="playAudio()">Close Modal and Play Audio</button>
        </div>
    </div> -->
                ...
                <div class="carousel-item position-relative active" style="height: 100vh; min-height: 400px;">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h1 class="display-1 font-secondary text-white mt-n3 mb-md-4">Taufiq & Paramita</h1>
